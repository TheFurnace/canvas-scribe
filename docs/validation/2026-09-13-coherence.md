...
- Production-component browser checks in Shared Tools desktop/dark stories: cross-view pen/color propagation, Default toolbar badge, quick colors, and PDF radial Default selection. PDF here is a tools preview, not the native Obsidian viewer.
