...
5. Hold the stylus barrel button, then touch and drag across ink. Whole strokes should erase and releasing the button should restore the selected tool for the next contact.
